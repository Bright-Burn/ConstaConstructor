...
const AlignPositionEndXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
...
export const AlignPositionEnd = createIcon({
  l: AlignPositionEndXs,
  m: AlignPositionEndXs,
  s: AlignPositionEndXs,
  xs: AlignPositionEndXs,
  name: 'AlignPositionEnd',
})
