...
const JustifyPositionCenterSizeXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      width="12"
      height="12"
...
export const JustifyPositionCenter = createIcon({
  l: JustifyPositionCenterSizeXs,
  m: JustifyPositionCenterSizeXs,
  s: JustifyPositionCenterSizeXs,
  xs: JustifyPositionCenterSizeXs,
  name: 'JustifyPositionCenter',
})
