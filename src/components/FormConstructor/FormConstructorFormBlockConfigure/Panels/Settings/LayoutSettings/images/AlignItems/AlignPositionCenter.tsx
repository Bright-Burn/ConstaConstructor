...
const AlignPositionCenterXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M11 11L9 11V10L11 10V11Z" fill="black" />
      <path d="M3 3H5V9H3V3Z" fill="black" />
      <path d="M6 5H8V7H6V5Z" fill="black" />
...
export const AlignPositionCenter = createIcon({
  l: AlignPositionCenterXs,
  m: AlignPositionCenterXs,
  s: AlignPositionCenterXs,
  xs: AlignPositionCenterXs,
