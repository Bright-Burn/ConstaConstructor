...
const JustifyPositionEndXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
...
export const JustifyPositionEnd = createIcon({
  l: JustifyPositionEndXs,
  m: JustifyPositionEndXs,
  s: JustifyPositionEndXs,
  xs: JustifyPositionEndXs,
  name: 'JustifyPositionEnd',
})
