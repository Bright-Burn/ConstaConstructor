...
const JustifyPositionSpaceAroundXs = () => {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M8 4H10V8H8V4Z" fill="black" />
...
export const JustifyPositionSpaceAround = createIcon({
  l: JustifyPositionSpaceAroundXs,
  m: JustifyPositionSpaceAroundXs,
  s: JustifyPositionSpaceAroundXs,
  xs: JustifyPositionSpaceAroundXs,
  name: 'JustifyPositionSpaceAround',
})
