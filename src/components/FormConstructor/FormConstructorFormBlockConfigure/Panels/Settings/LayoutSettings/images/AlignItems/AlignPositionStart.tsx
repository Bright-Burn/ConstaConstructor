...
const AlignPositionStartXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M6 3H8V5H6V3Z" fill="black" />
...
export const AlignPositionStart = createIcon({
  l: AlignPositionStartXs,
  m: AlignPositionStartXs,
  s: AlignPositionStartXs,
  xs: AlignPositionStartXs,
  name: 'AlignPositionStart',
})
