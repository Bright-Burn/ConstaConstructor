...
const JustifyPositionStartXs = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width='12' height='12' viewBox='0 0 12 12' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path d='M1 4H3V8H1V4Z' fill='black' />
      <path d='M4 4H6V8H4V4Z' fill='black' />
...
export const JustifyPositionStart = createIcon({
  l: JustifyPositionStartXs,
  m: JustifyPositionStartXs,
  s: JustifyPositionStartXs,
  xs: JustifyPositionStartXs,
  name: 'JustifyPositionStart',
})
