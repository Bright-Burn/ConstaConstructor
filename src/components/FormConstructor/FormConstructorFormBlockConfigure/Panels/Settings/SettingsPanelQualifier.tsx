...
import { BrandTextElementProps, FormElementDictTypes, FormGroupsTypes, TextElementProps } from '../../../coreTypes'
...
import { ConcreteSelectedElement, FormGroupsDictTypes, ISelectedElement, UnionProps } from "../../../coreTypes/types"
...
const getSettingsPanel = (selectedElementProps: UnionProps | null, selectedElement: ISelectedElement | null) => {
    if (selectedElement) {
        switch (selectedElement.elementType) {
            case FormElementDictTypes.Text: {
                ...
                return (
                    <>
                        <TextSettings selectedProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Informer: {
                ...
                return (
                    <>
                        <InformerSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Badge: {
                ...
                return (
                    <>
                        <BadgeSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Table: {
                ...
                return (
                    <>
                        <TableSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormGroupsDictTypes.Layout: {
                ...
                return (
                    <>
                        <LayoutSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormGroupsDictTypes.Card: {
                ...
                return (
                    <>
                        <CardSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormGroupsDictTypes.ButtonModal: {
                ...
                return (
                    <>
                        <ButtonModuleSettings selectedElementProps={selectedElementProps.props} selectedElement={element} />
                    </>
                )
            }
            case FormElementDictTypes.Tabs: {
                ...
                return (
                    <>
                        <TabsSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Checkbox: {
                ...
                return (
                    <>
                        <CheckboxSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.TextField: {
                ...
                return (
                    <>
                        <FilledSettings />
                        <TextFieldSettings selectedElementProps={selectedElementProps.props} selectedElement={element} />
                        <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.List: {
                ...
                return (
                    <>
                        <ListSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.RadioButton: {
                ...
                return (
                    <>
                        <RadioButtonSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Button: {
                ...
                return (
                    <>
                        <FilledSettings />
                        <ButtonSettings selectedElementProps={selectedElementProps.props} selectedElement={element} />
                        <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Switch: {
                ...
                return (
                    <>
                        <SwitchSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.DatePicker: {
                ...
                return (
                    <>
                        <DatePickerSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.ComboBox: {
                ...
                return (
                    <>
                        <ComboBoxSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Select: {
                ...
                return (
                    <>
                        <SelectSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.DataTime: {
                ...
                return (
                    <>
                        <DataTimeSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.PrototypeTextElement: {
                ...
                return <PrototypeSettings selectedElementProps={selectedElementProps.props} selectedElement={element} />
            }
            case FormElementDictTypes.PrototypeRectElement: {
                if (!isElementProps<BrandPrototypeRectProps>(selectedElementProps, 'PrototypeRectElement')) {
                    return
                }
                const element = {
                    elementId: selectedElement.elementId,
            ...
            case FormElementDictTypes.BreadcrumbsForm: {
                ...
                return (
                    <>
                        <BreadcrumbsSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.User: {
                ...
                return (
                    <>
                        <UserSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Tag: {
                ...
                return (
                    <>
                        <TagSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.ChoiceGroup: {
                ...
                return (
                    <>
                        <ChoiceGroupSettings selectedElementProps={selectedElementProps.props} selectedElement={element} /> <BaseSettings />
                    </>
                )
            }
            case FormElementDictTypes.Icon: {
                ...
                return <IconSettings selectedElementProps={selectedElementProps.props} selectedElement={element} />
            }
            default:
                return <></>
        }
...
export const SettingPanelQualifier: FC = () => {
    ...
    return <div className={`${styles.elementSettings} m-t-s`}>{getSettingsPanel(selectedElementProps, selectedElement)}</div>
}