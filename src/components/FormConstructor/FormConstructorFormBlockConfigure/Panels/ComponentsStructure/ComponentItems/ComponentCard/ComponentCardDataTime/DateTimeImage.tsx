...
const DateTimeImage = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox="0 0 200 120" fill="none" {...props}>
      ...
      <rect x={62} y={19} width={75} height={12} rx={3} fill="#002033" fillOpacity={0.35} />
      <rect x={37} y={19} width={11} height={12} rx={3} fill="#002033" fillOpacity={0.35} />
      <rect x={151} y={19} width={11} height={12} rx={3} fill="#002033" fillOpacity={0.35} />
    </svg>
  )
}
