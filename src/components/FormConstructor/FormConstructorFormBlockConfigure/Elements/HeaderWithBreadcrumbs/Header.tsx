...
import { headerWithBreadcrumbsProps, IFormElementHeaderWithBreadcrumbs } from '../../../store/formElements'
                ...
                leftSide={
                    <>
                        <div className={`container-row delimeter ${style.delimeter}`}>
                            <Text size='l' weight='bold'>Литология</Text>
                        </div>
                ...
                rightSide={
                    <>
                        <div className='container-row align-center'>
                            <IconRing size='m' />
                            <User name='Михаил Петров' info='Главный специалист' view='clear' className={style.userContainer} />
                        </div>
                    </>
                }
            />
